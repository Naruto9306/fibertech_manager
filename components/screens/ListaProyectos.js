...
// import { NetworkMapService, ProjectService } from '../../service/storage';
...
//         (proyecto.projectName && proyecto.projectName.toLowerCase().includes(searchQuery.toLowerCase())) ||
//         (proyecto.projectId && proyecto.projectId.toLowerCase().includes(searchQuery.toLowerCase())) ||
...
//     try {
//       setLoading(true);
//       const maps = await ProjectService.getProjects();
//       setProyectos(maps);
//       setFilteredProyectos(maps);
//     } catch (error) {
...
//           onPress: async () => {
//             try {
//               await NetworkMapService.deleteNetworkMap(proyecto.id || proyecto.projectId);
...
//     return proyecto.name || proyecto.projectId || t('unnamedProject');
//   };
...
//       onPress={() => navigation.navigate('ViewOnMap', { selectedMap: item })}
//     >
...
//       <Text style={[styles.proyectoItemDate, { color: colors.subText }]}>
