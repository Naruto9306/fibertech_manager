...
share: 'Share',
qrCodeNote: 'This QR code contains all the project data. Scan it with the app to import the entire project.',
...
storagePermissionMessage: 'The app needs access to storage to save the QR code.',
...
galleryScanningUnavailable: 'QR scanning from gallery is temporarily unavailable. Please use manual input.',
...
couldNotImportProject: 'Could not import project. Invalid or incomplete data.',
...
largeDataMessage: 'The QR code contains too much data to be displayed fully. Do you want to see a summarized version?',
largeDataContent: 'Content (summarized)',
largeDataInfo: 'The data is too large to be displayed fully. It has been copied to the clipboard.',
saveQR: 'Save QR',
saveQRMessage: 'Do you want to save the QR code as an image in your gallery?',
...
newNode: 'New nodes you create will automatically connect to this node. Select a node type to begin..',
...
permissionRequired: 'Permission required',
    galleryPermissionMessage: 'Permission is required to access the photo gallery',
  ...
  galleryPermissionMessage: "Se necesita permiso para acceder a la galería de fotos",
  errorSelectingImage: "Error al seleccionar la imagen",
  noQRFound: "QR no encontrado",
  noQRFoundMessage: "No se detectó ningún código QR en la imagen seleccionada",
  ...
  qrCodeProcessed: "Código QR procesado correctamente",
    ...
    tryAgain: 'Intentar otra vez',
      ...
      newNode: 'Los nuevos nodos que crees se conectarán automáticamente a este nodo. Selecciona un tipo de nodo para comenzar.',
...
largeDataMessage: 'El código QR contiene demasiados datos para mostrarse completamente. ¿Deseas ver una versión resumida?',
largeDataContent: 'Contenido (resumido)',
largeDataInfo: 'Los datos son demasiado grandes para mostrarse completamente. Se ha copiado al portapapeles.',
      couldNotImportProject: 'No se pudo importar el proyecto. Datos inválidos o incompletos.',
...
galleryScanningUnavailable: 'El escaneo de QR desde galería no está disponible temporalmente. Por favor usa la entrada manual.',
      loadFromGallery: "Cargar desde galería",
  permissionDenied: "Permiso denegado",
  galleryPermissionMessage: "Se necesita acceso a la galería para cargar imágenes",
...
storagePermissionMessage: 'La app necesita acceso al almacenamiento para guardar el código QR',
...
shareProjectDataMessage: 'Datos del proyecto {projectName}:\n{projectData}',
...
share: 'Compartir',
save: 'Guardar',
qrCodeNote: 'Este código QR contiene todos los datos del proyecto. Escanéelo con la app para importar el proyecto completo.',
...
noProjectsToDelete: 'No hay proyectos para eliminar',
  ...
  nameAndAddressRequired: 'El nombre y la dirección de donde se realizará el proyecto son requeridos',
