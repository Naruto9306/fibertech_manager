...
export const AppProvider = ({ children }) => {
  ...
  viewmap: 'To open the network map, you must acquire the Google Maps APY_KEY.',
  ...
  confirmDeleteMapMessage: 'Are you sure you want to delete this network map? This action cannot be undone.',
  confirmDeleteNode: 'Are you sure you want to delete this node? This action cannot be undone.',
  allMapsDeletedSuccessfully: 'Are you sure you want to delete all maps? This action cannot be undone.',
  ...
  confirmDeleteAllMapsMessage: 'Are you sure you want to delete ALL maps? This action cannot be undone.',
  cancel: 'Cancel',
  delete: 'Delete',
...
createMapsToSeeHere: 'Create network maps in the Projects section to see them here',
project: 'Project',
nodes: 'nodes',
...
confirmDeleteProjectMessage: 'Are you sure you want to delete the project "{name}"?',
projectDeletedSuccessfully: 'Successfully deleted project',
couldNotDeleteProject: 'The project could not be deleted',
confirmDeleteAllProjectsMessage: 'Are you sure you want to delete all {count} projects?',
allProjectsDeletedSuccessfully: 'All projects have been successfully deleted',
...
confirmDeleteProjectMessage: '¿Estás seguro de que quieres eliminar el proyecto "{name}"?',
projectDeletedSuccessfully: 'Proyecto eliminado correctamente',
couldNotDeleteProject: 'No se pudo eliminar el proyecto',
confirmDeleteAllProjectsMessage: '¿Estás seguro de que quieres eliminar todos los {count} proyectos?',
allProjectsDeletedSuccessfully: 'Todos los proyectos han sido eliminados correctamente',
...
noProjectsToDelete: 'No hay proyectos para eliminar',
  ...
  viewmap: 'Para abrir el mapa de la red, debe adquirir la APY_KEY de Google Maps.',
  ...
  confirmDeleteMapMessage: '¿Estás seguro de que quieres eliminar este mapa de red? Esta acción no se puede deshacer.',
  confirmDeleteNode: '¿Estás seguro de que quieres eliminar este nodo? Esta acción no se puede deshacer.',
  allMapsDeletedSuccessfully: '¿Seguro que quieres eliminar todos los mapas? Esta acción no se puede deshacer.',
  couldNotDeleteMap: 'No se pudo eliminar el mapa',
  confirmDeleteAll: 'Confirmar eliminar todo',
  confirmDeleteAllMapsMessage: '¿Estás seguro de que quieres eliminar TODOS los mapas? Esta acción no se puede deshacer.',
  cancel: 'Cancelar',
  delete: 'Eliminar',
...
createMapsToSeeHere: 'Crea mapas de red en la sección de Proyectos para verlos aquí',
